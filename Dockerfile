...
MAINTAINER hardy@ferentschik.de
...
# Create Hubot
RUN ~/.npm/bin/yo hubot --owner="Hardy Ferentschik <hardy@ferentschik.de>" --name="Minibot" --description="Minishift IRC Hubot" --defaults
